...
namespace CAso_de_estudio2
{
    ...
    {
        public void CalculadoraBasicaa()
        {
            int cam;
            do
            {
                ...
                do
                {
                    ...
                    do
                    {
                        ...
                        Console.Clear();
                        menu();
                        Console.WriteLine($"                Operacion a realizar para al numero: {Math.Round(numero1, 2)}");
                        Console.WriteLine(" ------------------------------------------------------------------------");
                    ...
                    else if (opcion == 3)
                    {
                        numero1 = numero1 / numero2;
                        Console.WriteLine(" ------------------------------------------------------------------------");
                        Console.WriteLine("                   El resultado de la divicion es:  " + Math.Round(numero1,2));
                        Console.WriteLine(" ------------------------------------------------------------------------");
                    }
                    else if (opcion == 4)
                    {
                    ...
                    Console.WriteLine(" ------------------------------------------------------------------------");
                    Console.WriteLine($"(1).- REALIZAR UNA OPERACIÓN AL RESULTADO  QUE ES: {Math.Round(numero1, 2)}");
